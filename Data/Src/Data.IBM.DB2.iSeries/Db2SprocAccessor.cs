...
namespace EntLibContrib.Data.IBM.DB2.iSeries
{
    ...
    public class Db2SprocAccessor<TResult> : CommandAccessor<TResult>
    {
        ...
        public Db2SprocAccessor(Db2Database database, string procedureName, IRowMapper<TResult> rowMapper)
        ...
        /// <param name="rowMapper">The <see cref="IRowMapper&lt;TResult&gt;"/> that will be used to convert the returned data to clr type <typeparamref name="TResult"/>.</param>
        public Db2SprocAccessor(Db2Database database, string procedureName, IParameterMapper parameterMapper, IRowMapper<TResult> rowMapper)
